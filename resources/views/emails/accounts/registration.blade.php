<body
    ...
    <div id="itlo" class="container"
        ...
        <div id="isph" class="content"
            ...
            <p id="i2ki9" style="box-sizing: border-box;">Thank you for signing up for {{ $name }}!
                You're almost ready to start using your account.
            </p>
            <p id="iqc2c" style="box-sizing: border-box;">Please confirm your registration by clicking the button
                below:
            </p>
            <a href="{{ $forwardurl }}" id="i1tbj" target="_blank" class="button"
                style="box-sizing: border-box; display: inline-block; padding-top: 10px; padding-right: 20px; padding-bottom: 10px; padding-left: 20px; margin-top: 20px; margin-right: 0px; margin-bottom: 20px; margin-left: 0px; background-color: rgb(0, 123, 255); color: rgb(255, 255, 255); text-decoration-line: none; text-decoration-thickness: initial; text-decoration-style: initial; text-decoration-color: initial; border-top-left-radius: 5px; border-top-right-radius: 5px; border-bottom-right-radius: 5px; border-bottom-left-radius: 5px;">Complete
                Registration</a>
            <p id="ipoex" style="box-sizing: border-box;">If you didn’t sign up for this account, please ignore this
                email.
            </p>
            <p id="iwtts" style="box-sizing: border-box;">Welcome aboard, and we’re excited to have you with us!
            </p>
        </div>
        <div id="ivrt9" class="footer"
            ...
            <p id="ippec" style="box-sizing: border-box;">Best regards,<br>
                The {{ $name }} Team
            </p>
        </div>
    </div>
