                    ...
                    <div class="row mb-6">
                        ...
                        <div class="col-lg-8 fv-row fv-plugins-icon-container">
                            <select name="country" aria-label="Select a Country" data-control="select2"
                                ...
                                data-select2-id="select2-data-9-0wgd" tabindex="-1" aria-hidden="true"
                                data-kt-initialized="1">
                                <option value="" data-select2-id="select2-data-11-hk0j">Select a Country...
                                </option>
                                ...
                                dir="ltr" data-select2-id="select2-data-10-vi8b" style="width: 100%;"><span
                                    class="selection"><span
                                        ...
                                        aria-disabled="false" aria-labelledby="select2-country-36-container"
                                        aria-controls="select2-country-36-container"><span
                                            class="select2-selection__rendered" id="select2-country-36-container"
                    ...
                    <div class="row mb-6">
                        ...
                        <div class="col-lg-8 fv-row fv-plugins-icon-container">
                            ...
                            <select name="language" aria-label="Select a Language" data-control="select2"
                                ...
                                data-select2-id="select2-data-12-1sg2" tabindex="-1" aria-hidden="true"
                                data-kt-initialized="1">
                                <option value="" data-select2-id="select2-data-14-sqda">Select a Language...
                                </option>
                                ...
                                dir="ltr" data-select2-id="select2-data-13-yc7q" style="width: 100%;"><span
                                    class="selection"><span
                                        class="select2-selection select2-selection--single form-select form-select-solid form-select-lg"
                                        role="combobox" aria-haspopup="true" aria-expanded="false" tabindex="0"
                                        aria-disabled="false" aria-labelledby="select2-language-f1-container"
                                        aria-controls="select2-language-f1-container"><span
                                            class="select2-selection__rendered" id="select2-language-f1-container"
                    ...
                    <div class="row mb-6">
                        ...
                        <div class="col-lg-8 fv-row fv-plugins-icon-container">
                            <select name="timezone" aria-label="Select a Timezone" data-control="select2"
                                ...
                                class="form-select form-select-solid form-select-lg select2-hidden-accessible"
                                data-select2-id="select2-data-15-ot67" tabindex="-1" aria-hidden="true"
                                data-kt-initialized="1">
                                <option value="" data-select2-id="select2-data-17-9dz4">Select a Timezone..
                                </option>
                                ...
                                dir="ltr" data-select2-id="select2-data-16-9sow" style="width: 100%;"><span
                                    class="selection"><span
                                        class="select2-selection select2-selection--single form-select form-select-solid form-select-lg"
                                        role="combobox" aria-haspopup="true" aria-expanded="false"
                                        tabindex="0" aria-disabled="false"
                                        aria-labelledby="select2-timezone-7g-container"
                                        aria-controls="select2-timezone-7g-container"><span
                                            class="select2-selection__rendered" id="select2-timezone-7g-container"
                    ...
                    <div class="row mb-6">
                        ...
                        <div class="col-lg-8 fv-row">
                            <select name="currnecy" aria-label="Select a Currency" data-control="select2"
                                ...
                                class="form-select form-select-solid form-select-lg select2-hidden-accessible"
                                data-select2-id="select2-data-18-f65f" tabindex="-1" aria-hidden="true"
                                data-kt-initialized="1">
                                <option value="" data-select2-id="select2-data-20-5918">Select a
                                    currency..</option>
                                ...
                                <option data-kt-flag="flags/japan.svg" value="JPY">JPY&nbsp;-&nbsp;Japanese
                                    yen</option>
                                <option data-kt-flag="flags/sweden.svg" value="SEK">SEK&nbsp;-&nbsp;Swedish
                                    krona</option>
                                <option data-kt-flag="flags/canada.svg" value="CAD">CAD&nbsp;-&nbsp;Canadian
                                    dollar</option>
                                <option data-kt-flag="flags/switzerland.svg" value="CHF">
                                    CHF&nbsp;-&nbsp;Swiss franc</option>
                            </select><span class="select2 select2-container select2-container--bootstrap5"
                                dir="ltr" data-select2-id="select2-data-19-kb9y" style="width: 100%;"><span
                                    class="selection"><span
                                        class="select2-selection select2-selection--single form-select form-select-solid form-select-lg"
                                        role="combobox" aria-haspopup="true" aria-expanded="false"
                                        tabindex="0" aria-disabled="false"
                                        aria-labelledby="select2-currnecy-zs-container"
                                        aria-controls="select2-currnecy-zs-container"><span
                                            class="select2-selection__rendered" id="select2-currnecy-zs-container"
                ...
                <div class="card-body border-top px-9 py-9">
                    ...
                    <label class="form-check form-check-custom form-check-solid align-items-start">
                        ...
                        <span class="form-check-label d-flex flex-column align-items-start">
                            ...
                            <span class="text-muted fs-6">Receive notifications for consistently failing webhook
                                API endpoints.</span>
                        </span>
                        <!--end::Label-->
                    </label>
                        ...
                        <div class="d-flex flex-stack flex-grow-1 ">
                            ...
                            <div class=" fw-semibold">
                                ...
                                <div class="fs-6 text-gray-700 ">For extra security, this requires you to confirm
                                    your email or phone number when you reset yousignr password. <br><a
