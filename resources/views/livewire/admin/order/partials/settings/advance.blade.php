<div class="card mb-5 mb-xl-10" x-data="{
    amount: $wire.entangle('advanceAmount'),
    mAmount: $wire.entangle('advanceAmountLimit'),
    ...
    <div class="card-header border-0 cursor-pointer" role="button" data-bs-toggle="collapse"
        ...
        <div class="card-title m-0">
            <h3 class="fw-bold m-0">Advance Payment</h3>
        </div>
        <!--end::Card title-->
    </div>
    <!--begin::Card header-->
    ...
    <div id="kt_account_settings_profile_details" class="collapse show">
        ...
        <div class="card-body border-top p-9">
            ...
            <div class="row mb-6">
                <!--begin::Label-->
                <label class="col-lg-4 col-form-label required fw-semibold fs-6">Advance Payment Limit</label>
                <!--end::Label-->
                <!--begin::Col-->
                <div class="col-lg-8 fv-row">
        ...
        <div class="card-footer d-flex justify-content-end py-6 px-9">
            <button wire:click='saveAdvance' onclick="KTApp.showPageLoading();" class="btn btn-primary"
