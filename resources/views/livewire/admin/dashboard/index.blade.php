            ...
            <div class="card card-xxl-stretch mb-xxl-8">
                ...
                <div class="card-header align-items-center border-0 mt-3">
                    <h3 class="card-title align-items-start flex-column">
                        ...
                        <span class="text-gray-500 mt-2 fw-semibold fs-6">More than 400+ new
                            members</span>
                    </h3>
                    <div class="card-toolbar">
                        <!--begin::Menu-->
                        ...
                        <div class="d-flex align-items-center flex-wrap flex-grow-1 mt-n2 mt-lg-n1">
                            ...
                            <div class="d-flex flex-column flex-grow-1 my-lg-0 my-2 pe-3">
                                <a href="#" class="fs-5 text-gray-800 text-hover-primary fw-bold">Cup &
                                    Green</a>
                                <span class="text-gray-500 fw-semibold fs-7 my-1">Study highway
                                    types</span>
                        ...
                        <div class="d-flex align-items-center flex-wrap flex-grow-1 mt-n2 mt-lg-n1">
                            ...
                            <div class="d-flex flex-column flex-grow-1 my-lg-0 my-2 pe-3">
                                <a href="#" class="fs-5 text-gray-800 text-hover-primary fw-bold">Desserts
                                    platter</a>
                                <span class="text-gray-500 fw-semibold fs-7 my-1">Food trends &
                                    reviews</span>
                                <span class="text-gray-500 fw-semibold fs-7">By:
                                    <a href="#" class="text-primary fw-bold">Figma
                                        Studio</a></span>
                            ...
                            <div class="d-flex align-items-center me-2">
                                ...
                                <div>
                                    <a href="#" class="fs-6 text-gray-800 text-hover-primary fw-bold">Top
                                        Authors</a>
                                    <div class="fs-7 text-muted fw-semibold mt-1">Ricky Hunt,
                                        Sandra Trepp</div>
                                </div>
                                <!--end::Title-->
                            </div>
