<div class="tab-pane fade" id="Jpills-four-example1" role="tabpanel" aria-labelledby="Jpills-four-example1-tab">
            ...
            <form class="js-validate">
                ...
                <div class="row">
                    <div class="offset-md-4 offset-lg-3 col-auto">
                        <button type="submit" class="btn btn-primary-dark btn-wide transition-3d-hover">Add
                            Review</button>
                    </div>
                </div>
            </form>
    ...
    <div class="border-bottom border-color-1 pb-4 mb-4">
        ...
        <p class="text-gray-90">Pellentesque habitant morbi tristique senectus et netus et
            ...
            eu tincidunt faucibus. Etiam justo ligula, placerat ac augue id, volutpat porta dui.</p>
