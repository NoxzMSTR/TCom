        ...
        @foreach ($categories as $key => $category)
            @if ($category['isFeatured'])
                <div class="col-md-6 mb-4 mb-xl-0 col-xl-3">
                    <a href="{{  route('public.shop', ['category' => $category['name']]) }}" class="d-black text-gray-90">
                        <div class="min-height-132 py-1 d-flex bg-gray-1 align-items-center">
                            ...
                            <div class="col-6 col-xl-7 col-wd-6">
                                ...
                                <div class="link text-gray-90 font-weight-bold font-size-15" href="{{  route('public.shop', ['category' => $category['name']]) }}">
                                    Shop now
