...
body {
  ...
  font-weight: 400;
  line-height: 1.5;
  color:{{ $sTextColor?$sTextColor:'#333e48' }};
  text-align: left;
...
h1, h2, h3, h4, h5, h6 {
  ...
  color:{{ $headingColor?$headingColor:'#333e48' }} !important;
}
...
a {
  color: {{ $textColor?$textColor:'#fed700' }};
...
.table-primary > th,
.table-primary > td {
  background-color:{{ $backgroundColor?$backgroundColor:'#fff' }}4b8;
}
...
.table-hover .table-primary:hover {
  background-color:{{ $backgroundColor?$backgroundColor:'#fff' }}09f;
}
...
.btn-primary {
  color: #1e2022;
  background-color: {{ $contentColor?$contentColor:'#fed700' }};
  border-color: {{ $borderColor?$borderColor:'#fed700' }};
}
...
.dropdown-item {
  ...
  clear: both;
  font-weight: 400;
  color: {{ $sTextColor?convertColor($sTextColor,'dark',15):'#334141' }};
  text-align: inherit;
  white-space: nowrap;
  background-color: transparent;
  border: 0;
...
.custom-control-input:not(:disabled):active ~ .custom-control-label::before {
  color: #fff;
  background-color:{{ $backgroundColor?$backgroundColor:'#fff' }}3b2;
  border-color: #fff3b2;
}
...
.card {
  ...
  background-color:{{ $cardColor?$cardColor:'#fff' }};
...
.alert-primary {
  color: #847000;
  background-color:{{ $backgroundColor?$backgroundColor:'#fff' }}7cc;
  border-color: #fff4b8;
}
...
.alert-warning {
  color: #856404;
  background-color:{{ $backgroundColor?$backgroundColor:'#fff' }}3cd;
  border-color: #ffeeba;
}
...
.bg-primary {
  background-color:{{ $contentColor?$contentColor:'#fed700' }} !important;
}
...
.bg-gray-1 {
  background-color:  {{ $backgroundColor?convertColor($backgroundColor,'dark',2):'#f5f5f5' }} !important;
}

a.bg-gray-1:hover, a.bg-gray-1:focus,
button.bg-gray-1:hover,
button.bg-gray-1:focus {
  background-color:  {{ $backgroundColor?convertColor($backgroundColor,'dark',2):'gainsboro' }} !important;
}

.bg-gray-2 {
  background-color:  {{ $backgroundColor?convertColor($backgroundColor,'dark',4):'#383838' }} !important;
}

a.bg-gray-2:hover, a.bg-gray-2:focus,
button.bg-gray-2:hover,
button.bg-gray-2:focus {
  background-color:  {{ $backgroundColor?convertColor($backgroundColor,'dark',4):'#1f1f1f' }} !important;
}

.bg-gray-3 {
  background-color: {{ $backgroundColor?convertColor($backgroundColor,'dark',6):'#eeeeee' }} !important;
}

a.bg-gray-3:hover, a.bg-gray-3:focus,
button.bg-gray-3:hover,
button.bg-gray-3:focus {
  background-color:  {{ $backgroundColor?convertColor($backgroundColor,'dark',6):'#d5d5d5' }} !important;
}

.bg-gray-4 {
  background-color:  {{ $backgroundColor?convertColor($backgroundColor,'dark',7.5):'#e6e6e6' }} !important;
}

a.bg-gray-4:hover, a.bg-gray-4:focus,
button.bg-gray-4:hover,
button.bg-gray-4:focus {
  background-color:  {{ $backgroundColor?convertColor($backgroundColor,'dark',7.5):'#cdcdcd' }} !important;
}

.bg-gray-5 {
  background-color:  {{ $backgroundColor?convertColor($backgroundColor,'dark',8.8):'#878787' }} !important;
}

a.bg-gray-5:hover, a.bg-gray-5:focus,
button.bg-gray-5:hover,
button.bg-gray-5:focus {
  background-color:  {{ $backgroundColor?convertColor($backgroundColor,'dark',8.8):'#6e6e6e' }} !important;
}

.bg-gray-6 {
  background-color:  {{ $backgroundColor?convertColor($backgroundColor,'dark',9.5):'#848484' }} !important;
}

a.bg-gray-6:hover, a.bg-gray-6:focus,
button.bg-gray-6:hover,
button.bg-gray-6:focus {
  background-color:  {{ $backgroundColor?convertColor($backgroundColor,'dark',9.5):'#6b6b6b' }} !important;
}

.bg-gray-7 {
  background-color:  {{ $backgroundColor?convertColor($backgroundColor,'dark',10.4):'#f9f9f9' }} !important;
}

a.bg-gray-7:hover, a.bg-gray-7:focus,
button.bg-gray-7:hover,
button.bg-gray-7:focus {
  background-color:  {{ $backgroundColor?convertColor($backgroundColor,'dark',10.4):'#e0e0e0' }} !important;
}

.bg-gray-8 {
  background-color:  {{ $backgroundColor?convertColor($backgroundColor,'dark',11.6):'#7b8186' }} !important;
}

a.bg-gray-8:hover, a.bg-gray-8:focus,
button.bg-gray-8:hover,
button.bg-gray-8:focus {
  background-color:  {{ $backgroundColor?convertColor($backgroundColor,'dark',11.6):'#63676b' }} !important;
}

.bg-gray-9 {
  background-color:  {{ $backgroundColor?convertColor($backgroundColor,'dark',12.8):'#8f8f8f' }} !important;
}

a.bg-gray-9:hover, a.bg-gray-9:focus,
button.bg-gray-9:hover,
button.bg-gray-9:focus {
  background-color:  {{ $backgroundColor?convertColor($backgroundColor,'dark',12.8):'#767676' }} !important;
}

.bg-gray-13 {
  background-color:  {{ $backgroundColor?convertColor($backgroundColor,'dark',13.7):'#f8f8f8' }} !important;
}

a.bg-gray-13:hover, a.bg-gray-13:focus,
button.bg-gray-13:hover,
button.bg-gray-13:focus {
  background-color:  {{ $backgroundColor?convertColor($backgroundColor,'dark',13.7):'#dfdfdf' }} !important;
}

.bg-gray-14 {
  background-color:  {{ $backgroundColor?convertColor($backgroundColor,'dark',14.4):'#eaeaea' }} !important;
}

a.bg-gray-14:hover, a.bg-gray-14:focus,
button.bg-gray-14:hover,
button.bg-gray-14:focus {
  background-color:  {{ $backgroundColor?convertColor($backgroundColor,'dark',14.4):'#d1d1d1' }} !important;
}

.bg-gray-15 {
  background-color:  {{ $backgroundColor?convertColor($backgroundColor,'dark',15.3):'#9d9c9c' }} !important;
}

a.bg-gray-15:hover, a.bg-gray-15:focus,
button.bg-gray-15:hover,
button.bg-gray-15:focus {
  background-color:  {{ $backgroundColor?convertColor($backgroundColor,'dark',15.3):'#848282' }} !important;
}

.bg-gray-16 {
  background-color:  {{ $backgroundColor?convertColor($backgroundColor,'dark',16.8):'#606060' }} !important;
}

a.bg-gray-16:hover, a.bg-gray-16:focus,
button.bg-gray-16:hover,
button.bg-gray-16:focus {
  background-color:  {{ $backgroundColor?convertColor($backgroundColor,'dark',16.8):'#474747' }} !important;
}

.bg-gray-17 {
  background-color:  {{ $backgroundColor?convertColor($backgroundColor,'dark',17.2):'#ecedf2' }} !important;
}

a.bg-gray-17:hover, a.bg-gray-17:focus,
button.bg-gray-17:hover,
button.bg-gray-17:focus {
  background-color:  {{ $backgroundColor?convertColor($backgroundColor,'dark',17.2):'#ced0dd' }} !important;
}

.bg-gray-18 {
  background-color:  {{ $backgroundColor?convertColor($backgroundColor,'dark',18.9):'#333e484d' }} !important;
}
...
.bg-white {
  background-color:{{ $backgroundColor?$backgroundColor:'#fff' }} !important;
}
...
.border-primary {
  border-color: {{ $borderColor?$borderColor:'#fed700' }} !important;
}
...
.text-primary {
  color: {{ $textColor?$textColor:'#fed700' }} !important;
}
...
.text-dark {
  color:{{ $sTextColor?$sTextColor:'#333e48' }} !important;
}
...
.text-gray-1 {
  color: {{ $sTextColor?convertColor($sTextColor,'dark',1):'#f5f5f5' }} !important;
}

a.text-gray-1:hover, a.text-gray-1:focus {
  color: {{ $sTextColor?convertColor($sTextColor,'dark',1):'#cfcfcf' }} !important;
}

.text-gray-2 {
  color: {{ $sTextColor?convertColor($sTextColor,'dark',1.6):'#383838' }} !important;
}

a.text-gray-2:hover, a.text-gray-2:focus {
  color: {{ $sTextColor?convertColor($sTextColor,'dark',1.6):'#121212' }} !important;
}

.text-gray-3 {
  color: {{ $sTextColor?convertColor($sTextColor,'dark',2.4):'#eeeeee' }} !important;
}

a.text-gray-3:hover, a.text-gray-3:focus {
  color: {{ $sTextColor?convertColor($sTextColor,'dark',2.4):'#c8c8c8' }} !important;
}

.text-gray-4 {
  color: {{ $sTextColor?convertColor($sTextColor,'dark',3.6):'e6e6e6' }} !important;
}

a.text-gray-4:hover, a.text-gray-4:focus {
  color: {{ $sTextColor?convertColor($sTextColor,'dark',3.6):'silver' }} !important;
}

.text-gray-5 {
  color: {{ $sTextColor?convertColor($sTextColor,'dark',4.4):'#878787' }} !important;
}

a.text-gray-5:hover, a.text-gray-5:focus {
  color: {{ $sTextColor?convertColor($sTextColor,'dark',4.4):'#616161' }} !important;
}

.text-gray-6 {
  color: {{ $sTextColor?convertColor($sTextColor,'dark',5.4):'#848484' }} !important;
}

a.text-gray-6:hover, a.text-gray-6:focus {
  color: {{ $sTextColor?convertColor($sTextColor,'dark',5.4):'#5e5e5e' }} !important;
}

.text-gray-7 {
  color: {{ $sTextColor?convertColor($sTextColor,'dark',6.4):'#f9f9f9' }} !important;
}

a.text-gray-7:hover, a.text-gray-7:focus {
  color: {{ $sTextColor?convertColor($sTextColor,'dark',6.4):'lightgray' }} !important;
}

.text-gray-8 {
  color: {{ $sTextColor?convertColor($sTextColor,'dark',7.4):'#7b8186' }} !important;
}

a.text-gray-8:hover, a.text-gray-8:focus {
  color: {{ $sTextColor?convertColor($sTextColor,'dark',7.4):'#565b5e' }} !important;
}

.text-gray-9 {
  color: {{ $sTextColor?convertColor($sTextColor,'dark',8.4):'#8f8f8f' }} !important;
}

a.text-gray-9:hover, a.text-gray-9:focus {
  color: {{ $sTextColor?convertColor($sTextColor,'dark',8.4):'dimgray' }} !important;
}

.text-gray-13 {
  color: {{ $sTextColor?convertColor($sTextColor,'dark',9.4):'#f8f8f8' }} !important;
}

a.text-gray-13:hover, a.text-gray-13:focus {
  color: {{ $sTextColor?convertColor($sTextColor,'dark',9.4):'#d2d2d2' }} !important;
}

.text-gray-14 {
  color: {{ $sTextColor?convertColor($sTextColor,'dark',10.4):'#eaeaea' }} !important;
}

a.text-gray-14:hover, a.text-gray-14:focus {
  color: {{ $sTextColor?convertColor($sTextColor,'dark',10.4):'#c4c4c4' }} !important;
}

.text-gray-15 {
  color: {{ $sTextColor?convertColor($sTextColor,'dark',11.4):'#9d9c9c' }} !important;
}

a.text-gray-15:hover, a.text-gray-15:focus {
  color: {{ $sTextColor?convertColor($sTextColor,'dark',11.4):'#777676' }} !important;
}

.text-gray-16 {
  color: {{ $sTextColor?convertColor($sTextColor,'dark',12.4):'#606060' }} !important;
}

a.text-gray-16:hover, a.text-gray-16:focus {
  color: {{ $sTextColor?convertColor($sTextColor,'dark',12.4):'#3a3a3a' }} !important;
}

.text-gray-17 {
  color: {{ $sTextColor?convertColor($sTextColor,'dark',13.4):'#ecedf2' }} !important;
}

a.text-gray-17:hover, a.text-gray-17:focus {
  color: {{ $sTextColor?convertColor($sTextColor,'dark',13.4):'#bfc2d3' }} !important;
}

.text-gray-18 {
  color: {{ $sTextColor?convertColor($sTextColor,'dark',14.4):'#333e484d' }} !important;
}

a.text-gray-18:hover, a.text-gray-18:focus {
  color: {{ $sTextColor?convertColor($sTextColor,'dark',14.4):'rgba(19, 23, 27, 0.301961)' }} !important;
}
...
.badge-outline-primary {
  color: #1e2022;
  background: {{ $backgroundColor?$backgroundColor:'#fed700' }};
  border-color: #fff;
}
...
/* Background Color */
.card-bg-light {
  background-color: {{ $cardColor?convertColor($cardColor,'light',15):'#f8fafd' }};
}

.card-bg-light:hover {
  background-color: {{ $cardColor?convertColor($cardColor,'light',20):'#f4f7fc' }};
}
...
.card-text-dark {
  color: {{ $textColor?convertColor($textColor,'dark',15):'#1e2022' }};
}

.card-text-dark:hover {
  color: {{ $textColor?convertColor($textColor,'dark',15):'#377dff' }};
}
...
.card-btn-arrow {
  display: inline-block;
  color: {{ $sTextColor?convertColor($sTextColor,'dark',15):'#377dff' }};
  margin-left: 1rem;
  transition: 0.3s ease-in-out;
}
...
.nav-classic .nav-link.active {
  color: {{ $textColor?$textColor:'#fed700' }};
  border-bottom-color: {{ $borderColor?$borderColor:'#fed700' }};
}
...
.fill-primary {
  fill: {{ $contentColor?$contentColor:'#fed700' }} !important;
}
...
.stop-color-primary {
  stop-color: {{ $contentColor?$contentColor:'#fed700' }} !important;
}
...
.stroke-primary {
  stroke: {{ $contentColor?$contentColor:'#fed700' }} !important;
}
...
.u-slick-thumb-progress__custom .slick-current.js-slide::before, .u-slick-thumb-progress__custom .slick-current.js-slide::after {
  position: absolute;
  content: " ";
  border-top: 2px solid {{ $borderColor?$borderColor:'#fed700' }};
}
...
.nav-tab .nav-link {
  ...
  padding: .5rem .3rem;
  font-size: 1.125rem;
  color: {{ $sTextColor?convertColor($sTextColor,'dark',35):'#343f49' }};
}

.nav-tab .nav-link:hover {
  color: {{ $sTextColor?convertColor($sTextColor,'dark',20):'#343f49' }};
}

.nav-tab .nav-link.active {
  font-weight: 700;
  color: {{ $sTextColor?convertColor($sTextColor,'dark',5):'#343f49' }};
  position: relative;
}
...
------------------------------------*/
.text-gray-30 {
  color: {{ $sTextColor?convertColor($sTextColor,'dark',16):'#a0a0a0' }};
}

.text-gray-50 {
  color: {{ $sTextColor?convertColor($sTextColor,'dark',17):'#959595' }};
}

.text-gray-60 {
  color: {{ $sTextColor?convertColor($sTextColor,'dark',18):'#6b6b6b' }};
}
...
.text-gray-70-imp {
  color: {{ $sTextColor?convertColor($sTextColor,'dark',15):'#334141' }}; !important;
}
...
.text-gray-100 {
  color: {{ $sTextColor?convertColor($sTextColor,'dark',19):'#343f49' }};
}

.text-gray-110 {
  color: {{ $sTextColor?convertColor($sTextColor,'dark',20):'#7c7c7c' }};
}

.text-gray-111 {
  color: {{ $sTextColor?convertColor($sTextColor,'dark',21):'#686c6f' }};
}

.text-gray-20 {
  color: {{ $sTextColor?convertColor($sTextColor,'dark',15.5):'#7d7d7d' }};
}

.text-gray-23 {
  color: {{ $sTextColor?convertColor($sTextColor,'dark',16.5):'#aeaeae' }};
}

.text-gray-25 {
  color: {{ $sTextColor?convertColor($sTextColor,'dark',16.6):'#acacac' }};
}

.text-gray-27 {
  color: {{ $sTextColor?convertColor($sTextColor,'dark',18.7):'#575560' }};
}
...
.text-gray-300 {
  color: {{ $sTextColor?convertColor($sTextColor,'dark',25.5):'#b0b0b0' }};
}

.text-gray-32 {
  color: {{ $sTextColor?convertColor($sTextColor,'dark',17.2):'#a7a7a7' }};
}

.text-gray-39 {
  color: {{ $sTextColor?convertColor($sTextColor,'dark',17.3):'#434343' }};
}

.text-gray-41 {
  color: {{ $sTextColor?convertColor($sTextColor,'dark',17.5):'#989898' }};
}

.text-gray-44 {
  color: {{ $sTextColor?convertColor($sTextColor,'dark',18.5):'#9f9f9f' }};
}
...
.border-top-primary {
  border-top-color: {{ $borderColor?$borderColor:'#fed700' }} !important;
}

.border-right-primary {
  border-right-color: {{ $borderColor?$borderColor:'#fed700' }}!important;
}

.border-bottom-primary {
  border-bottom-color: {{ $borderColor?$borderColor:'#fed700' }} !important;
}

.border-left-primary {
  border-left-color: {{ $borderColor?$borderColor:'#fed700' }} !important;
}
...
.product-item {
  border-bottom: 1px solid {{ $borderColor?convertColor($borderColor,'dark',15):'#eaeaea' }};
}
...
.product-item::after {
  content: '';
  border-right: 1px solid {{ $borderColor?convertColor($borderColor,'dark',15):'#eaeaea' }};
  display: block;
  position: absolute;
  top: 50%;
  right: 0;
...
------------------------------------*/
.prodcut-box-shadow {
  box-shadow: 0px 0px 0px 4px {{ $backgroundColor?convertColor($backgroundColor,'light',10):'#f9f9f9' }};
}
...
.custom-menu-item {
  ...
  .custom-menu-item:hover, .custom-menu-item:focus, .custom-menu-item:active, .custom-menu-item:hover, .custom-menu-item:focus, .custom-menu-item:active {
    color:{{ $sTextColor?$sTextColor:'#333e48' }};
    font-weight: 700 !important;
    background-color:{{ $contentColor?$contentColor:'#fed700' }};
  }
