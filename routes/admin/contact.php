...
use App\Livewire\Admin\Contact\ContactDatatable;
...
Route::middleware([Authenticated::class])->prefix('admin/contact')->as('admin.contact.')->group(function () {
    Route::get('/list', [ContactDatatable::class, 'view'])->name('list');
});
